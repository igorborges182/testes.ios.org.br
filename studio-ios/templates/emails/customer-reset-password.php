...
<p><?php esc_html_e( 'Se você não fez essa solicitação, ignore este e-mail. Se você gostaria de prosseguir:', 'woocommerce' ); ?></p>
<p>
	<a class="link" href="<?php echo esc_url( add_query_arg( array( 'key' => $reset_key, 'id' => $user_id ), wc_get_endpoint_url( 'lost-password', '', wc_get_page_permalink( 'myaccount' ) ) ) ); ?>"><?php // phpcs:ignore ?>
		<?php esc_html_e( 'Clique aqui para redefinir sua senha', 'woocommerce' ); ?>
	</a>
</p>
