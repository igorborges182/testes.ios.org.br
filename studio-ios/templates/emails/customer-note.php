...
<p><?php esc_html_e( 'A seguinte nota foi adicionada ao seu pedido:', 'woocommerce' ); ?></p>
...
<p><?php esc_html_e( 'Para a sua referência, aqui estão os detalhes do seu pedido:', 'woocommerce' ); ?></p>
